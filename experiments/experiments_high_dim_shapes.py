...
FILE_NAME = "~/Downloads/results_experiments_high_dim_new_"  + str(args.n_layers) + '_' + str(args.noise) +  ".csv"
DICT_NAME_APP = "high_dim_"  +  str(args.n_layers) + '_' + str(args.noise)
